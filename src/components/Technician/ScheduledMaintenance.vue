...
export default {
  setup() {
    ...
    const scheduled_maintanance = ref(null)
    ...
    function get_scheduled_maintenance() {
      axios
        .get('api/get-scheduled-maintenance')
        .then((response) => {
    ...
    function write_report(item) {
      scheduled_maintanance.value = item.id
    ...
    function save_report() {
      ...
      axios
        .post('api/save-report/' + scheduled_maintanance.value,report.value)
        .then((response) => {
